...
Shower::Shower(u8_t displayDIO, u8_t displayCLK, u8_t button, u8_t temperatureButton1, u8_t temperatureButton2, u8_t temperatureButton3, u8_t temperatureButton4)
    : showerTimer(displayDIO, displayCLK), button(button), temperatureButtons{temperatureButton1, temperatureButton2, temperatureButton3, temperatureButton4} {};
